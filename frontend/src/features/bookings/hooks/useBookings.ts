...
//     daysInOffice: 0,
//     teamInOffice:0  // replaces recurringCount / recurringPattern
//   });
...
//       setSummary(deriveBookingSummary(current, future, past,teamGroups);
//     } catch (err) {
...
//     setError(null);
//     try {
//       // ✅ Capture all 4 results — including teamGroups
//       const [current, future, past, groups] = await Promise.all([
//         fetchCurrentBookings(),
//         fetchFutureBookings(),
//         fetchPastBookings(),
//         fetchTeamGroups(),
...
//       // ✅ Pass groups as 4th argument so teamInOffice is derived correctly
//       setSummary(deriveBookingSummary(current, future, past, groups));
//     } catch (err) {
//       setError(err instanceof Error ? err.message : "Failed to load bookings");
//     } finally {
//       setIsLoading(false);
